...
class Expense {
  ...
  factory Expense.fromMapServer(Map<String, dynamic> json) => Expense(id: json['id'], title: json['title'], description: json['description'], amount: json['amount'], category: json['category'], date: DateTime.parse(json['date']), payment_method: json['payment_method']);
